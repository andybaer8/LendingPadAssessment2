...
namespace WebApi.Controllers
{
    ...
    public class ProductController : BaseApiController
    {
        ...
        [Route("list")]
        [HttpGet]
        public HttpResponseMessage GetProducts(int skip, int take, string name = null, string description = null, double? minPrice = null, double? maxPrice = null)
        {
            var products = _getProductService.GetProducts(name, description, minPrice, maxPrice)
                                       .Skip(skip).Take(take)
        ...
        [Route("list/price")]
        [HttpGet]
        public HttpResponseMessage GetProductsByPrice(double price)
        {
            var products = _getProductService.GetProductsByPrice(price)
                                       .Select(q => new ProductData(q))
                                       .ToList();
            return Found(products);
        }
